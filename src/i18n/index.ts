  ...
  en: {
    translation: {
      ...
      contact: {
        ...
        readyToStartSecond: 'Let\'s create something amazing together.',        sendMessage: 'Send us a message',
        name: 'Full Name',
        email: 'Email Address',
        phone: 'Phone Number',
  ...
  ar: {
    translation: {
      ...
      contact: {
        ...
        getInTouch: 'تواصل',
        touch: 'معنا',
        readyToStart: 'مستعد لبدء مشروعك القادم؟',
        readyToStartSecond: 'لنخلق شيئاً مذهلاً معاً.',
